...
export default function PrivacyPolicyPage() {
    return (
        <main className="max-w-3xl mx-auto px-4 py-10 text-sm leading-relaxed text-gray-700">
            ...
            <p className="mb-4">
                Le site <strong>Surchope</strong> est un projet communautaire et ludique, sans but
            ...
            <p>
                Ces données sont utilisées uniquement pour permettre l’affichage des couples, la
                gestion des votes, et la modération des contenus. Aucune donnée n’est vendue,
            ...
            <ul className="list-disc ml-6 mb-4">
                <li>
                    <strong>Firebase (Google Cloud)</strong> – authentification, base de données et
                    stockage
                </li>
                <li>
            ...
            <p>
                Ces services peuvent transférer des données hors de l’Union européenne, conformément
